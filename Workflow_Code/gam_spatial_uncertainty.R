...
save.image(file.path('/tmp', fn))  ## /scratch/users/paciorek/paleon/preds_gam_for_science.Rda
...
## posterior time contrasts - year 500 (idx = 5) vs. all other years

cbind(1:100,sapply(1:100, function(i) mean(spatialAvgDrawsByTime[5,,] > spatialAvgDrawsByTime[i,,])))
