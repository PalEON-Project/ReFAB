...
A <-
  ggplot() + theme_bw() + theme(legend.text=element_text(size=25),
...
B <-
  ...
  geom_jitter(data = temp.precip.bio,
              ...
              size = 4)#+ stat_smooth(data = temp.precip.bio, aes(x = y, y = Mean), method = "lm",
...
C <-
  ...
  geom_jitter(data = temp.precip.bio,
              ...
              size = 4)#+ stat_smooth(data = temp.precip.bio, aes(x = y, y = total), method = "lm",
